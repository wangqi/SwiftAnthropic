...
public struct MessageResponse: Decodable {
  ...
  /// CodingKeys for decoding - decoder uses .convertFromSnakeCase strategy
  private enum CodingKeys: String, CodingKey {
    case id, type, model, role, content, stopReason, stopSequence, usage, container
  }

  public init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)

    // All fields use decodeIfPresent with sensible defaults for robustness
    ...
    // Usage with fallback to empty usage if missing
    self.usage = try container.decodeIfPresent(Usage.self, forKey: .usage) ?? Usage.empty
  ...
  public struct Usage: Codable {
    ...
    /// Empty usage for fallback when usage data is missing
    ...
    private enum CodingKeys: String, CodingKey {
      case inputTokens, outputTokens, thinkingTokens, cacheCreationInputTokens, cacheReadInputTokens, serverToolUse
    }

    public init(from decoder: Decoder) throws {
      let container = try decoder.container(keyedBy: CodingKeys.self)

      // All fields use decodeIfPresent with defaults for robustness
      ...
      self.thinkingTokens = try container.decodeIfPresent(Int.self, forKey: .thinkingTokens)
      ...
      self.serverToolUse = try container.decodeIfPresent(ServerToolUse.self, forKey: .serverToolUse)
    }
    ...
    public func encode(to encoder: Encoder) throws {
      ...
      try container.encodeIfPresent(thinkingTokens, forKey: .thinkingTokens)
      ...
      try container.encodeIfPresent(serverToolUse, forKey: .serverToolUse)
    }
  }
